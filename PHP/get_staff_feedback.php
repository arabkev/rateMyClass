...
if (isset($_GET["staff_id"])){
  ...
  $sql_query = "SELECT AVG(Interesting_Rating) as avg_interesting, AVG(Interactive_Rating) as avg_interactive, AVG(Informative_Rating) as avg_informative, AVG(Intelligible_Rating) as avg_intelligible, AVG(Innovative_Rating) as avg_innovative FROM feedback INNER JOIN class ON feedback.Class_ID=class.Class_ID WHERE (class.Staff_ID = $staff_id)";
