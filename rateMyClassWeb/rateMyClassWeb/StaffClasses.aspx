<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="StaffClasses.aspx.cs" Inherits="rateMyClassWeb.StaffClasses" MasterPageFile="~/Master.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
    ...
    <!--<script type="text/javascript">
        ...
        $(document).ready(function () { google.load('visualization', '1', { 'packages': ['corechart'], callback: loadData }); });

    </script>-->
    
    <form runat="server">
        <div>
            <h1>Classes by Lecturer</h1>
        </div>
        <div>
            <asp:DropDownList ID="lecturerList" runat="server" OnSelectedIndexChanged="ChangeLecturer" AutoPostBack="true" />
        </div>
