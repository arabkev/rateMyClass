...
{
    public partial class YearClasses : System.Web.UI.Page
    {
        ...
        private void BindListView()
        {
            ...
            try
            {
                ...
                queryStr = "SELECT class.*, staff.* FROM class INNER JOIN staff ON class.Staff_ID=staff.Staff_ID WHERE class.Module_Code LIKE CONCAT(@year, '%')";
                //queryStr = "SELECT * FROM class WHERE Class_ID = @id";
                cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
                string tmp = "AC" + yearList.SelectedItem.ToString();
                Response.Write(queryStr);
                cmd.Parameters.AddWithValue("@year", tmp);
        ...
        public void ChangeYear(object sender, System.EventArgs e)
        {
            BindListView();
        }
